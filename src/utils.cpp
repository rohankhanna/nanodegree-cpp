 ...
 */
void drawBoundingBoxOnImage(Mat &image, double yMin, double xMin, double yMax, double xMax, double score, const string& label, bool scaled=true) {
    cv::Point tl, br;
    if (scaled) {
 ...
 */
double IOU(const Rect2f& box1, const Rect2f& box2) {
